...
<head>
<title>RAIA - JobSeeker SignIn</title>
...
<div id="wrapper"> 
 ...
 <?php include('includes/header.php');?>
  ...
  <section id="inner-banner" style="background-color: #363636;">
    <div class="container">
...
<div class="input-box"> 
       <input type="submit" value="Sign in" name="signin">
            ...
            <div class="login-social">
              <p style=" text-decoration: none;">Don't have an account? <a href="sign-up.php"> Sign up</a></p>  </div>
