...
{               ?>
                ...
                <div class="text-col">
                  ...
                  <a href="#" class="text"><i class="fa fa-map-marker"></i><?php  echo htmlentities($row->jobLocation);?></a> <a href="#" class="text"><i class="fa fa-calendar"></i><?php  echo htmlentities($row->postinDate);?> </a> <strong class="price"><i class="fa fa-money"></i>P<?php  echo htmlentities($row->salaryPackage);?></strong>
     ...
     <a href="jobs-details.php?ajid=<?php echo ($row->jobId);?>" class="btn-style-1">Apply for this Job</a>
      ...
      <?php } ?>   
                ...
                <div class="clearfix">
                  ...
                  <p>P <?php  echo ($row->salaryPackage);?></p>
