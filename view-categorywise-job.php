...
<title>RAIA - Categorywise Job</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-8">
            ...
            <div id="content-area">
              ...
              <h2 style="color: #363636"> <?php  echo htmlentities($_GET['viewid']);?> Jobs</h2> 
...
{               ?>
                  ...
                  <div class="box">
                    ...
                    <strong class="price" style="padding-top: 15px;"><i class="fa fa-money"></i>P<?php  echo htmlentities($row->salaryPackage);?></strong> 
