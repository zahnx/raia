...
<?php include_once('includes/header.php');?>
  ...
  <div class="banner-outer">
    <div id="banner" class="element" style="background-image: url(images/hero-bg.jpg)")>  </div>
    <div class="caption">
      <div class="holder">
        <h1>Reach Heights: Be RAIA!</h1>
...
{               ?>
          <div class="col-md-3 col-sm-6">
            ...
            <div class="box"> <img src="images/categ-glass.png" alt="img" width="68" height="68">
              ...
              <strong style="font-size: 22px;"><i class="fa fa-users"></i><?php  echo htmlentities($row->totaljobs);?></strong>
...
$sql="SELECT tbljobs.*,tblemployers.CompnayLogo,tblemployers.CompnayName from tbljobs join tblemployers on tblemployers.id=tbljobs.employerId ORDER BY postinDate DESC LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
{               ?>
                  <div class="box">
                    ...
                    <div class="thumb"><a href="jobs-details.php?jid=<?php echo ($row->jobId);?>"><img src="employers/employerslogo/<?php echo $row->CompnayLogo;?>" width="200" height="200"></a></div>
                    ...
                    <div class="text-col">
                      ...
                      if ($row->isActive == 1){
                        ...
                        echo "<p style='color: red;'>Job-Filled</p>";
                      }
                    ...
                    <p class="btn-1 btn-color-1 ripple"><i class="btn-1 fa fa-money"></i> P<?php echo htmlentities($row->salaryPackage);?></p>
