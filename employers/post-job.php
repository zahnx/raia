...
<title>RAIA - Employers Job Posting</title>
...
<input type="text" placeholder="e.g. P7000 - 9000" name="salarypackage" required>
...
<input type="text" placeholder="e.g. Pasig, Makati, Mandaluyong" name="joblocation" required>
