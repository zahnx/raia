...
<html>
<head>
<title>RAIA - Job Details Employers</title>
...
<strong class="price"><i class="fa fa-money"></i>P<?php echo htmlentities($result->salaryPackage); ?></strong>
...
<a href="candidates-listings.php" class="btn-style-1 style-big">List of Canditates apllied for this job</a> </div>
