...
<title>RAIA - Employer Job listing</title>
...
<div id="wrapper"> 
  ...
  <div id="main" > 
    ...
    <section class="candidates-search-bar" style="background-image: url('../images/hero-bg.jpg'); min-height:500px;">
      <div class="container" style="padding-top: 8%;">
        <form method="post" action="job-search.php" style="background-color: rgba(105,105,105, 0.4); ">
          <div class="row">
            <div class="col-md-10">
...
<div class="thumb">
 <!-- logo --> 
  <a href="job-details.php?jobid=<?php echo htmlentities($result->jobId);?>"><img src="employerslogo/<?php echo htmlentities($result->CompnayLogo);?>" alt="img" width="180" height="140"></a></div>
...
<!-- Job Package --> 
<strong class="price" style="padding-top: 20px;"><i class="fa fa-money" ></i>P<?php echo htmlentities($result->salaryPackage); ?></strong> <br />
