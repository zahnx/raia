...
<title>RAIA - Update Account Details</title>
...
<label>Location</label>
 <input type="text" name="location" placeholder="e.g. Pasig, Mandaluyong, Makati" autocomplete="off" value="<?php echo htmlentities($result->lcation)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Established In</label>
 <input type="text" name="estin" placeholder="e.g. 14 Sept 2018, Manila" autocomplete="off" value="<?php echo htmlentities($result->establishedIn)?>">
</div>
