...
<title>RAIA - View Applied Job History </title>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-8">
            ...
            <div class="resumes-content">
              ...
              <div class="box">
              <h2 style="color: #363636 ">Job Details</h2>
 <?php
...
$sql = "select tbljobs.*,tblapplyjob.* from tblapplyjob join tbljobs on tblapplyjob.JobId=tbljobs.jobId  where tblapplyjob.UserId=:uid and tblapplyjob.JobId=:jobid;";
