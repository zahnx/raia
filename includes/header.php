...
<?php if (strlen($_SESSION['jsid']==0)) {?>
              <li><a href="sign-in.php">Jobseekers</a>
              </li>
...
{               ?>
          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <img src="images/<?php echo $row->ProfilePic;?>" width="60" height="60" style="border-radius: 70px;" ></button>
<?php $cnt=$cnt+1;}} ?>
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
